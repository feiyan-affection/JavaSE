 ...
 * @Author: think
 * @Project: JavaSE
 * @Date: Created in 2018/8/12 16:09
 * @Since: JDK 1.8
 * @Version: 1.0
 * @Modified By:
...
class Repertory {
    ...
    public LinkedList<Products> store = new LinkedList<Products>();
     ...
     */
    public synchronized void push(Products p,String threadName)
    {
    ...
    public void run() {
        while (true) {
            synchronized(Producer.class){
                ...
                repertory.push(products,Thread.currentThread().getName());
            }
...
class Consumers implements Runnable {
    ...
    Repertory repertory=null;
    //构造方法初始化repertory(仓库)
    public Consumers(Repertory repertory) {
        this.repertory=repertory;
    }
...
public class ProductersAndConsumers {
    public static void main(String[] args) {
        ...
        //定义两个消费者(c1,c2)
        Consumers c1=new Consumers(repertory);
        Consumers c2=new Consumers(repertory);
